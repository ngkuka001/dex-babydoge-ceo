...
import { Col, Grid, Image, Layout, Menu, Row, Space } from 'antd';
...
import { DEFAULT_NAVIGATION, renderNavigation } from './contants';
...
const Header: FC<HeaderProps> = () => {
  ...
  const currentPage = useMemo(() => {
    return renderNavigation().reduce((cur: any, acc) => {
  ...
  return screens.md ? (
    ...
    <header id="header">
      <div className="container">
        ...
        <Navigation navigation={renderNavigation()} mode="horizontal" currentPage={currentPage} />
